...
return [
     ...
     *
     * Raised above the package default (10MB) because the Document
     * resource's file field allows uploads up to 20MB (maxSize(20480) in
     * App\Filament\Resources\Documents\Schemas\DocumentForm). Left at the
     * default, any file between 10MB and 20MB would pass Filament's field
     * validation but then throw an unhandled FileIsTooBig exception the
     * moment it was actually attached to the media collection -- a 500
     * error instead of the graceful validation message the field promises.
     * Set a little above 20480KB so the field's own rule is the one that
     * actually binds.
     */
