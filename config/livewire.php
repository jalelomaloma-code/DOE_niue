...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        // Raised above the package default (12MB) because the Document
        // resource's file field allows uploads up to 20MB (maxSize(20480)
        // in App\Filament\Resources\Documents\Schemas\DocumentForm). Left at
        // the default, this global cap intercepted every upload above 12MB
        // before Filament's own field-level rule ever ran, silently making
        // maxSize(20480) unreachable. This is set a little above 20480 so
        // the field's own rule -- not this blanket ceiling -- is what
        // actually enforces the 20MB document limit.
